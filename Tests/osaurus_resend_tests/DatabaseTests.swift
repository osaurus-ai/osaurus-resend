...
struct DatabaseTests {
    ...
    func hasOutboundMessageSince() {
        ...
        #expect(DatabaseManager.hasOutboundMessageSince(threadId: "t-ts", sinceTimestamp: now - 10) == true)
        #expect(DatabaseManager.hasOutboundMessageSince(threadId: "t-ts", sinceTimestamp: now + 10) == false)
    }
}
